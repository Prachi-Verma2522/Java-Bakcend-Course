...
/*
	...
	username is by default root and password is blank(in case you haven't set the password at the time of installing mysql
...
public DB() {//default constructor

	try {
		
		Class.forName("com.mysql.cj.jdbc.Driver");//forName-> static method; here we are loading the driver class
		System.out.println("[DB] 1. Driver Loaded");
		
		String url = "jdbc:mysql://localhost/customerms"; // customerms->name of the db in mysql
		String user = "root";
		String password = "";
